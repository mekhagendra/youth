...
const Edit: React.FC<Props> = ({ supporter }) => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(`/admin/supporters/${supporter.id}`);
    };
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="max-w-2xl mx-auto">
                ...
                <div className="bg-white rounded-lg shadow p-6">
                    <h1 className="text-2xl font-bold text-gray-900 mb-6">Edit Supporter: {supporter.name}</h1>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md hover:border-gray-400 transition-colors">
                                <div className="space-y-1 text-center">
                                    ...
                                    <p className="text-xs text-gray-500">
                                        PNG, JPG, GIF up to 2MB. Leave empty to keep current logo.
                                    </p>
                                </div>
                            </div>
                            {errors.logo && (
                        ...
                        <div className="flex justify-end space-x-4 pt-6 border-t">
                            ...
                            <Button
                                ...
                                className="px-6"
                            >
                                {processing ? 'Updating...' : 'Update Supporter'}
                            </Button>
                        </div>
                    </form>
                </div>
