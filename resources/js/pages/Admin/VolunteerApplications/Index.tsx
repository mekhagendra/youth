...
export default function Index({ applications, filters }: Props) {
    ...
    const handleFilterChange = (status: string) => {
        ...
        router.get('/admin/volunteer-applications', { status }, {
            preserveState: true,
            preserveScroll: true,
        });
    };
    ...
    return (
        <AppLayout>
            <Head title="Volunteer Applications - Admin" />
            ...
            <div className="space-y-6">
                ...
                <div className="flex justify-between items-center">
                    <div>
                        ...
                        <p className="text-gray-600 mt-1">Manage volunteer application requests</p>
                    </div>
                </div>
                ...
                {applications.last_page > 1 && (
                    <div className="flex justify-center items-center space-x-2">
                        {Array.from({ length: applications.last_page }, (_, i) => i + 1).map((page) => (
                            <button
                                key={page}
                                onClick={() => router.get('/admin/volunteer-applications', { page, status: statusFilter })}
