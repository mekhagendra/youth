...
export default function Edit({ team, members }: Props) {
    const form = useForm({
        name: team.name,
    ...
    const [selectedMembers, setSelectedMembers] = useState<TeamMemberForm[]>(
        team.members.map(m => ({
            member_id: m.id,
    ...
    const handleSubmit = (e: FormEvent) => {
        ...
        // Use router.put directly with all data
        router.put(`/admin/teams/${team.id}`, {
            name: form.data.name,
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div className="mb-6 flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-gray-600">Update team details and manage member assignments</p>
                        </div>
                    </div>
