...
export default function VolunteerApplication() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post('/opportunities/volunteer');
    };

    return (
        <>
            <Head title="Volunteer Opportunities - Youth Initiative" />
            <PublicHeader />
                    ...
                    <div className="max-w-3xl mx-auto">
                        ...
                        <div className="text-center mb-8">
                            ...
                            <p className="text-xl text-gray-600">
                                Join our community and make a difference in young people's lives
                            </p>
                        </div>
                        ...
                        <div className="bg-white rounded-xl shadow-lg p-8">
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                {/* Why Volunteer */}
                                <div>
                                    <Label htmlFor="why_volunteer">Why do you want to volunteer? (Max 1000 characters)</Label>
                                    <textarea
                                        id="why_volunteer"
                                        value={data.why_volunteer}
                                        onChange={(e) => setData('why_volunteer', e.target.value)}
                                        placeholder="Tell us about your motivation and what you hope to contribute..."
                                        className="w-full border rounded-md px-3 py-2 min-h-[120px]"
                                        maxLength={1000}
                                    />
                                    {errors.why_volunteer && <p className="text-sm text-red-600 mt-1">{errors.why_volunteer}</p>}
                                </div>
